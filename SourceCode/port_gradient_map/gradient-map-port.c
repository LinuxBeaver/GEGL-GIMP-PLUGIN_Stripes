...
#define GEGL_OP_NAME gradient_map_port
#define GEGL_OP_C_SOURCE gradient-map-port.c
...
gegl_op_class_init (GeglOpClass *klass)
{
  ...
  gegl_operation_class_set_keys (operation_class,
      "name",       "port:gradient-map",
      "title"      , _("Gradient Map"),
      "categories", "color",
      "reference-hash", "669ccb10db850cbb7cc1647d94f03224beaver",
      "reference-hashB", "c497e7da934d524cfb252e5e1a16ff20beaver",
      "reference-composition", composition,
      "description", _("Applies a color gradient."),
    "gimp:menu-path", "<Image>/Colors/",
    "gimp:menu-label", _("Gradient Map..."),
      NULL);
}
